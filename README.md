...
This repository contains the official PyTorch implementation of **AudioCAN** [[paper](https://ieeexplore.ieee.org/abstract/document/11524076)], evaluated using the [MetaAudio benchmark](https://github.com/CHeggan/MetaAudio-A-Few-Shot-Audio-Classification-Benchmark).
