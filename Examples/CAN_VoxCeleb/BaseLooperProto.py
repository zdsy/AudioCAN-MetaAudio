"""
Scripts loops over base learner models in a sequnetial fashion. Aim is to have the
...
if __name__ == '__main__':
    ...
    if params['data']['variable']:
        ...
        # batch_funcs = [prep_batch_fixed, prep_batch_fixed_can_val]
    ...
    for mod in model_list:
        ...
        for i in model_loop:
            ...
            model = Model(scale_cls=1, num_classes=876).to(device, dtype=torch.float)
